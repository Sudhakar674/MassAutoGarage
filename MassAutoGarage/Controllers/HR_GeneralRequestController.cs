    ...
    public class HR_GeneralRequestController : Controller
    {
        ...
        public ActionResult GeneralRequest(HR_GeneralRequestModel model, string Id)
        {
            ...
            if (Id != null)
            {
                ...
                if (lst.SalaryCertificate != "0")
                {
                    lst.SalaryCertificate = "checked";
                    //lst.SalaryCertificate = "True";
                    //model.SalaryCertificate= "True";
                    //model.SalaryCertificate = "checked";
                }
                else
                {
                ...
                if (lst != null)
                {
                    ...
                    //model.SalaryCertificate = __SalaryCertificate;
