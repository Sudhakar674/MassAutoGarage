    ...
    $.ajax({
        ...
        success: function (result) {
            ...
            $.each(result, function (i, val) {
                ...
                row += "<td><a href='/CustomerAttachment/" + val.AttachmentFile + "' id='LetterFile' target='_blank' class='btn btn-sm btn-primary edit-item-btn'> View File</a></td>"
