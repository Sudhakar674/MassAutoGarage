...
function EditDepartment(i) {
    ...
    var _ID = $("#example tBody tr:eq(" + s + ")").find(".clsdeptid").val();
    var _DepartmentName = $("#example tBody tr:eq(" + s + ")").find(".clsDepartmentName").val();

    $("#DeptID").val(_ID);
    $("#DepartmentName").val(_DepartmentName);
    $("#btnSave").val('Update');
