 ...
 * 
 *  <button class="responsive-button hide-responsive-button last btn btn-sm btn-default" id="amm-preview-responsive" style="display:none;">
                  <span class="glyphicon glyphicon-eye-open"></span>
                  <span class="text_value">`+ canvas_info.i18n.previewText + `</span>
            </button>
 */
...
(function (global, $) {
    ...
    $.fn.imageMaker = function (options) {
        ...
        var initialElements = function (canvas_info) {
            ...
            $.each(canvas_info.templates, function (delta, img) {
                ...
                buildImagesMemes += '<img typeof="foaf:Image" id="imggen" width="' + canvas_info.template_thumbnail_width + '" height="' + canvas_info.template_thumbnail_height + '" src="' + img.url + '" title="' + img.title + '">';
    ...
    <div class="wrapper-memes-preview-operations">
           ...
           <button  class="trigger-element first fileUpload btn btn-soft-success shadow-none" target_element_triggered=".amm-addImage" id="amm-merge-image-trigger" style=" background-color:#d7a51a; font-size: 13px; color: white;">
             ...
             <button  class="btn btn-soft-success shadow-none" id="amm-brushes" style=" background-color: #4b38b3; font-size: 13px; color: white;">
             <span class="glyphicon glyphicon-pencil"></span>
             <span class="text_value">`+ canvas_info.i18n.drawText + `</span>
            </button>      
           
             <button href="#" class="trigger-element responsive-button hide-responsive-button first fileUpload btn btn-soft-success shadow-none"
                  target_element_triggered="#amm-input-upload-image-meme-responsive"  id="amm-upload-image-meme-responsive" style=" background-color:#2fa38d; font-size: 13px; color: white;">
                <input type="file" class="upload" id="amm-input-upload-image-meme-responsive" name="addImage-responsive">
                <span class="glyphicon glyphicon-paperclip"></span>
                <span class="text_value">`+ canvas_info.i18n.addTemplateText + `</span>
            </button>
    ...
    <form class="form-generat-meme" action="meme-generator-callback" method="post" enctype="multipart/form-data">
     ...
     <table border="0" cellpadding="0" cellspacing="0" class="display table " style="width:100%">
     <tr>
      <td>
       <input type="text" style=" width: 28%; background-color: #fb9800; border: none;border-radius: 3px;" readonly="readonly" /> <label>Dent</label>
      </td>
       <td>
        <input type="text" style=" width:25%; background-color:red; border: none; border-radius: 3px;" readonly="readonly" /> <label>RE-Painted</label>
      </td>
       <td>
       <input type="text" style=" width:28%; background-color: #4646fb; border: none; border-radius: 3px;" readonly="readonly" /> <label>Faded</label>
      </td>
       <td>
        <input type="text" style=" width:28%; background-color: #000000; border: none;border-radius: 3px;" readonly="readonly" /> <label>Broken</label>
      </td>
       <td>
        <input type="text" style="width:28%; background-color: #ffff00; border: none;border-radius: 3px; " readonly="readonly" /> <label>Scratch</label>
      </td>
     </tr>
      </table>
      </div>
    ...
    `+ buildImagesMemes + `
     ...
     <button class="add_textbox btn btn-success form-submit edit-add-textbox"  name="op" value="add_textbox" type="button">`+ canvas_info.i18n.addTextBoxText + `</button>
      ...
      <div class="table-responsive" id="webcamdiv" style="margin-top: 2%;">
        <table id="tblCamera" border="0" cellpadding="0" cellspacing="0" class="table table-bordered" style="width:100%;">
        <tr>
            <th align="center"><u>Live Camera</u>
            
            </th>
        </tr>
       
        <tr  style="background-color: #626161;">
         ...
         <tr>
            <td align="center">
                <input type="button" id="btnCapture" value="Capture" class="btn btn-outline-success"/>
            </td>
         ...
         <tr>            
            <td style="text-align: -webkit-center;"><img id="imgCapture" /></td>
        </tr>
       
         <tr>
           
            <td align="center">
                <input type="button" id="btnUpload" value="Download" disabled="disabled" class="btn btn-outline-success"/>
            </td>
        </tr>
    </table>
    </div>
